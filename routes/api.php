...
Route::get('/reservation/findd/{id}', 'App\Http\Controllers\ReservationController@findDetailsReservation');
...
Route::put('/user/edit/{id}', 'App\Http\Controllers\UserController@updateUser');
...
Route::middleware('auth:sanctum')->post('/images', [ RessourcesController::class, 'store']);
...
Route::put('/reservation/{id}/{idres}', 'App\Http\Controllers\ReservationController@updateReservation');
...
Route::get('/reservation/findbyiduser/{id}', 'App\Http\Controllers\ReservationController@findReservationByIdUser');
...
Route::put('/edit',[JwtAuthController::class,'update']);
